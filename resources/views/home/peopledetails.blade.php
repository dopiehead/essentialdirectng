    ...
    <div class="row">
        ...
        <div  class="col-md-4">
           ...
           <div class='wanted_info'>
                ...
                <p> <i class="fa fa-phone"></i> Contact:</p><br>

                
                <p>Joined :</p><br>

                <p>Last seen online</p><br>

                <button class="btn btn-info">Request to see more</button>
...
<a onclick="report()"><i class="fa fa-flag"></i> Report this person</a>
...
<h3>Businesses<span class="see_more">See more</span></h3><br>
